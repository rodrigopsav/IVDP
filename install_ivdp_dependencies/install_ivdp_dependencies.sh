...
#-----------------------------#
"
conda install -y -n ivdp -c conda-forge parallel
...
#-----------------------------#
"
conda install -y -n ivdp -c trent dos2unix 
...
#------------------------#
"
conda install -y -n ivdp -c conda-forge sed 
...
#------------------------#
"
conda install -y -n ivdp -c anaconda git
...
#-------------------------#
"
conda install -y -n ivdp -c anaconda pigz
...
#-----------------------------#
"
conda install -y -n ivdp -c anaconda datamash
...
#---------------------------#
"
conda install -y -n ivdp -c bioconda fastqc
...
#--------------------------------#
"
conda install -y -n ivdp -c bioconda fastq_utils
...
#--------------------------#
"
conda install -y -n ivdp -c bioconda seqtk
...
#----------------------------#
"
conda install -y -n ivdp -c bioconda -c conda-forge multiqc
...
#---------------------------------#
"
conda install -y -n ivdp -c bioconda trimmomatic
...
#--------------------------#
"
conda install -y -n ivdp -c bioconda bbmap
...
#----------------------------#
"
conda install -y -n ivdp -c bioconda bowtie
...
#----------------------------#
"
conda install -y -n ivdp -c bioconda bowtie2
...
#------------------------#
"
conda install -y -n ivdp -c bioconda bwa
...
#-----------------------------#
"
conda install -y -n ivdp -c bioconda bwa-mem2
...
#-------------------------------#
"
conda install -y -n ivdp -c anaconda zlib
conda install -y -n ivdp -c bioconda gmap
...
#---------------------------#
"
#conda install -y -n ivdp -c biobuilds hisat2
...
#-------------------------#
"
conda install -y -n ivdp -c bioconda star
...
#-----------------------------#
"
conda install -y -n ivdp -c bioconda sambamba
...
#---------------------------#
"
conda install -y -n ivdp -c bioconda picard
...
#-----------------------------------#
"
conda install -y -n ivdp -c bioconda gatk4
...
#------------------------------#
"
conda install -y -n ivdp2 -c bioconda freebayes
#./conda config --add channels defaults
#./conda config --add channels bioconda
#./conda config --add channels conda-forge
...
#-----------------------------#
"
conda install -y -n ivdp2 -c bioconda platypus-variant
...
#-----------------------------#
"
conda install -y -n ivdp -c bioconda varscan
#cd $INSTALL_FOLDER
...
#-----------------------------#
"
conda install -y -n ivdp -c bioconda vcftools
...
#--------------------------#
"
conda install -y -n ivdp -c bioconda plink
conda install -y -n ivdp -c bioconda plink2
...
#-----------------------------#
"
conda install -y -n ivdp -c bioconda bedtools
...
TMPDIR=$INSTALL_FOLDER/tmp pip install htseq
wait
...
#----------------------------------#
"
conda install -y -n ivdp -c bioconda subread
...
#---------------------------------------#
"
conda install -y -n ivdp -c bioconda snpeff 
conda install -y -n ivdp -c bioconda snpsift
...
#---------------------------#
"
conda install -y -n ivdp -c bioconda vcflib
conda install -y -n ivdp2 -c bioconda vcflib
...
#----------------------------#
"
conda install -y -n ivdp -c conda-forge firefox
