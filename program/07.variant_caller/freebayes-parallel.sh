...
cd $BAM_TMP
freebayes-parallel <(fasta_generate_regions.py $REFERENCE.fai 100000) $THREADS -f $REFERENCE -L bamlist_fb.list --min-base-quality 20 --genotype-qualities > $VCF_TMP/"$ALIGNER"_"$CALLER"_raw.vcf
wait
