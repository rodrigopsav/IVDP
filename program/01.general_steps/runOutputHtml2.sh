...
rm -r "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/fastqQC 2>/dev/null
rm -r "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/downsampling* 2>/dev/null

if [[ -d "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/alignment/bqsr ]]; then
   rm -r "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/alignment/raw 2>/dev/null
   rm -r "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/alignment/mdup 2>/dev/null

elif [[ -d "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/alignment/mdup ]]; then
   rm -r "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/alignment/raw 2>/dev/null
...
rm -r "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/stats/fastqQC 2>/dev/null
rm -r "$OUTPUT_DIR"/ivdp_"$OUTPUT_NAME"/data/stats/alignment 2>/dev/null
wait
